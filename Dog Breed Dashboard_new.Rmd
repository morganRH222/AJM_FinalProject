...
**📊 Summary:** See key metrics (total breeds, most/least popular, biggest riser/faller) plus average trait scores and their distributions.
...
<style>
  ...
  .shiny-valuebox .value-box {
    height: 18vh;                 # 5 boxes ≈ full column height
    display: flex;
...
### 🔍 Select Traits to Explore Correlation {data-height=40}
```{r}
...
### 📉 Scatterplot: Selected Traits {data-height=60}
```{r}
